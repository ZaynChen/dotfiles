...
assert(beautiful.init(theme_path), "beautiful init failed, theme_path: " .. theme_path, "beautiful init failed")
...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey, altkey }, "j", function() awful.layout.inc(1) end,
    { description = "select next", group = "layout" }),
  awful.key({ modkey, altkey }, "k", function() awful.layout.inc(-1) end,
    { description = "select previous", group = "layout" }),
  awful.key({ modkey, altkey }, "t", function() awful.layout.set(awful.layout.suit.spiral.dwindle) end,
    { description = "select dwidle layout", group = "layout" }),
  awful.key({ modkey, altkey }, "s", function() awful.layout.set(awful.layout.suit.floating) end,
...
ruled.client.connect_signal("request::rules", function()
  ...
  -- }
  ruled.client.append_rule {
    rule_any   = { class = { "firefox-developer-edition" } },
